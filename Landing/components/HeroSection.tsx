    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        <div className="max-w-3xl">
          ...
          {/* H1 — fluid */}
          <h1 className="mt-7 text-display text-white whitespace-pre-line">
            홈페이지 제작,{"\n"}
            <span className="text-gradient">얼마인지 먼저</span>{"\n"}
            알려드립니다.
          </h1>

          <p className="mt-7 max-w-2xl text-lead text-white/80">
            {SITE.hero.sub}
          </p>
