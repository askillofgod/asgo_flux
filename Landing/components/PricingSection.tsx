...
export default function PricingSection() {
  return (
    <section
      id="pricing"
      className="relative bg-[var(--bg-soft)] py-20 sm:py-24 md:py-28"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-14 grid gap-7 sm:gap-6 md:gap-7 md:grid-cols-3 md:items-stretch">
          {PRICING.map((p) => (
            <PricingCard key={p.id} product={p} />
          ))}
        </div>

        <p className="mt-10 text-center text-xs sm:text-sm text-[var(--text-muted)]">
